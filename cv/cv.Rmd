...
`r if (params$two_page || params$five_page) {"For a full list of publications see my full CV ([bit.ly/TarenSanders](https://bit.ly/TarenSanders))."}`
...
peer_reviewed_citations %>%
  dplyr::filter(if (params$two_page || params$five_page) short_cv else TRUE) %>%
  arrange(desc(issued))
```
